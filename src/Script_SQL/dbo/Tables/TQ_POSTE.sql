CREATE TABLE [dbo].[TQ_POSTE](
	...
	[CLE_CONNEXION] [nvarchar](50) NULL,
	...
	[RESID_PAR_DEFAUT] [nvarchar](20) NULL,
	[IMPR_BDG] [nvarchar](100) NULL,
	[IMPR_LISTING] [nvarchar](100) NULL,
	[IMPR_PLAN] [nvarchar](100) NULL,
	[PHOTO_SRC_RESID] [nvarchar](100) NULL,
	[PHOTO_DEST_RESID] [nvarchar](100) NULL,
	[PHOTO_SRC_VISIT] [nvarchar](100) NULL,
	[PHOTO_DEST_VISIT] [nvarchar](100) NULL,
	[PHOTO_SRC_PLAN] [nvarchar](100) NULL,
	[PHOTO_DEST_PLAN] [nvarchar](100) NULL,
	[LOGO1] [nvarchar](100) NULL,
	[LOGO2] [nvarchar](100) NULL,
	[LOGO3] [nvarchar](100) NULL,
	[LOGO4] [nvarchar](100) NULL,
	[LOGO5] [nvarchar](100) NULL,
	[FICHIER_IMPORTATION] [nvarchar](10) NULL,
	[SEPARATEUR] [nvarchar](5) NULL,
	[CHAMP1] [nvarchar](20) NULL,
	[CHAMP2] [nvarchar](20) NULL,
	[CHAMP3] [nvarchar](20) NULL,
	[CHAMP4] [nvarchar](20) NULL,
	[CHAMP5] [nvarchar](20) NULL,
	[CHAMP6] [nvarchar](20) NULL,
	[CHAMP7] [nvarchar](20) NULL,
	[CHAMP8] [nvarchar](20) NULL,
	[CHAMP9] [nvarchar](20) NULL,
	[CRITERE_IMPORT_CHAMP] [nvarchar](20) NULL,
	[POS_CHAMP1] [int] NULL,
	[POS_CHAMP2] [int] NULL,
	[POS_CHAMP3] [int] NULL,
	[POS_CHAMP4] [int] NULL,
	...
	[POS_CHAMP8] [int] NULL,
	[POS_CHAMP9] [int] NULL,
	[MAJ_FICHIER] [nvarchar](20) NULL,
	[MAJ_SITE] [nvarchar](50) NULL,
	[MAJ_SOCIETE] [nvarchar](50) NULL,
	...
	[TYPE_CONTROL_ACCES] [nvarchar](30) NULL,
	...
	[TRACAGE] [int] NULL,
	[FICHIER_TRACE] [nvarchar](50) NULL,
	[ENVOI_BDG_MANUEL] [int] NULL,
	[ENVOI_BDG_AUTO] [int] NULL,
	[GENERATION_BDG] [int] NULL,
	[DEBUT_CODE] [nvarchar](20) NULL,
	[MILIEU_CHAMP] [nvarchar](20) NULL,
	[MILIEU_FORMAT] [nvarchar](20) NULL,
	[FIN_CODE] [nvarchar](20) NULL,
	[GENERATION_BDG_MAX] [int] NULL,
	[MODE_ES_VIS_RES] [nvarchar](40) NULL,
	[VISITEUR_CTRL_PLUS] [nvarchar](4) NULL,
	[MATRA] [nvarchar](30) NULL,
	[ENVOI_MAIL] [int] NULL,
	[MODIF_VISITEUR] [int] NULL,
	[CHAMPS_VISITEUR] [nvarchar](4000) NULL,
	[REPSCAN] [nvarchar](100) NULL,
	[CHEMIN_EXPORT] [nvarchar](300) NULL,
	[CREATION_VISITE_PARKING] [int] NULL,
	[CTRL_RES_PARKING] [int] NULL,
	[MOUVEMENT_PARKING] [int] NULL,
	[DUREE_CONSERVATION] [int] NULL,
	[HEURE_EPURATION] [nvarchar](10) NULL,
	[ENVOI_MSG_PARKING] [int] NULL,
	[GENERATION_BDGR] [int] NULL,
	[DEBUT_CODER] [nvarchar](20) NULL,
	[MILIEU_FORMATR] [nvarchar](20) NULL,
	[FIN_CODER] [nvarchar](20) NULL,
	[GENERATION_BDGR_MAX] [int] NULL,
	[GENERATION_BDGVEH] [int] NULL,
	[DEBUT_CODEVEH] [nvarchar](20) NULL,
	[MILIEU_FORMATVEH] [nvarchar](20) NULL,
	[FIN_CODEVEH] [nvarchar](20) NULL,
	...
	[DEBUT_CODEEXT] [nvarchar](20) NULL,
	[MILIEU_FORMATEXT] [nvarchar](20) NULL,
	[FIN_CODEEXT] [nvarchar](20) NULL,
	[COCHER_PHS] [int] NULL,
	[CTRL_ACTIF] [int] NULL, 
