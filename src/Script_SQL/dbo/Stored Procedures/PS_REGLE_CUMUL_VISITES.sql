...
AS
	...
	DECLARE @ANNEE_GLISSANTE NVARCHAR(14)
	DECLARE @JOURS INTEGER
	DECLARE @DUREE_PERIODE INTEGER
	DECLARE @MODE_COMPTAGE NVARCHAR(1)
	DECLARE @TMPINT NVARCHAR(20)
BEGIN
	...
	--INSERT INTO ALARME (ALARMEID,LIBELLE,DATECREATIOn,DATEMAJ)VALUEs(0,CAST(@JOURS AS NVARCHAR(15))+':@MODE'+@MODE_COMPTAGE+':MAx'+CAST(@NBR_MAX AS NVARCHAR(10))+'ANNE:'+@ANNEE_GLISSANTE+'DUREE'+CAST(@DUREE_PERIODE AS NVARCHAR(5)),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)
