CREATE PROCEDURE [dbo].[GETMEETING_FOR_ADDMEETING_INNES]
...
/****** Objet :  StoredProcedure [dbo].[GETMEETING_FOR_MODMEETING_INNES]    Date de génération du script : 06/16/2014 10:09:11 ******/
SET ANSI_NULLS ON