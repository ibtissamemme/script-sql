CREATE PROCEDURE [dbo].[PS_IMPORT_VISITES_RESA_OPENPORTAL]
	...
	@REMAIL VARCHAR(150),
	@REFRESA VARCHAR(30),
	@ROBSERVATION VARCHAR(200),
	@RTYPEVISITE VARCHAR(30),
	@RIMMATRICULATION VARCHAR(30),
	@RMARQUE VARCHAR(30),
	@RSTATUTINSCRIPTION VARCHAR(1),
	@ID VARCHAR(25) OUTPUT
AS
	DECLARE @FLAG VARCHAR(14)
	DECLARE @IDENTITY VARCHAR(14)
	DECLARE @nomprenomanimateur VARCHAR(70)
	DECLARE @SOCIETEANIMATEUR VARCHAR(40)
	DECLARE @CODEANIMATEUR VARCHAR(14)
	DECLARE @CODERESERVATION VARCHAR(30)
	DECLARE @CODELGRESERVATION VARCHAR(30)
	DECLARE @MYIDOUT VARCHAR(20)
	DECLARE @DATE_DEBUT DATETIME
	DECLARE @HEURE_DEBUT DATETIME
	DECLARE @HEURE_FIN DATETIME
	DECLARE @INTERLOCUTEURID VARCHAR(30)
	DECLARE @EXTERNALID VARCHAR(30)
	DECLARE @LOCMYID INT
	DECLARE @nomprenomvisit VARCHAR(100)
	DECLARE @codesalle VARCHAR(100)
	DECLARE @lieu VARCHAR(100)
	DECLARE @NBVISITE INT
	DECLARE @siteid VARCHAR(20)
	DECLARE @GUICHETID VARCHAR(20)
	DECLARE @DATEACTION VARCHAR(20)
	DECLARE @DATEFIN VARCHAR(20)
	DECLARE @MYRSOCIETE VARCHAR(70)
BEGIN
