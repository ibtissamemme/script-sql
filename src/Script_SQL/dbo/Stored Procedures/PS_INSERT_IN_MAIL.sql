CREATE PROCEDURE [dbo].[PS_INSERT_IN_MAIL]
 ...
 @NOM_SALLE NVARCHAR(14),
 @SUJET_MAIL NVARCHAR(120),
 @BODY_MAIL NVARCHAR(4000)
AS
DECLARE @SITEID_TARGET NVARCHAR(14)
SET @SITEID_TARGET=NULL

DECLARE @SITE_TARGET NVARCHAR(35)
SET @SITE_TARGET=NULL

DECLARE @TOADDRESS_TARGET NVARCHAR(1000)
